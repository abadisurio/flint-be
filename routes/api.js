...
const { registerUser, signinUser, getAllMovies, getAllMoviesWithLink,
    ...
    getMovieLevels, getFilteredMoviesWithDetail, getLeveledMoviesWithDetail
} = require('../handler')
